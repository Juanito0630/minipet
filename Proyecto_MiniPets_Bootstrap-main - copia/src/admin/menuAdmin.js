          ...
          ${this.usuarios.map(
            (usuario) => html`
              <tr>
                ...
                <td>
                <button @click="${() => this.abrirModal()}" class="w-100 mt-5  border buton p-2 rounded border-10"> Actualizar</button>
                <div id="miModal" class="modal">
                  ...
                  <td>
                  <button type="button" class="w-100 mt-5  border buton p-2 rounded border-10" @click="${() => this.eliminarUsu(usuario.identificacion)}">Eliminar</button></td>
                  </tr>`
                  )} 
                </tbody>
                </table>
